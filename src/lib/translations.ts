...
export const translations: Record<string, TranslationKeys> = {
  en: {
    ...
    pdfBreakEvenPeriod: 'Break-Even Point',
    ...
    captureSignature: 'Client Signature',
    signatureCaptured: 'Client Signed',
    clear: 'Clear',
  },
  es: {
    title: 'SolarClose',
    ...
    envCo2Offset: 'Compensación de CO2',
    envTreesPlanted: 'Árboles Plantados',
    envEquivalent: 'equivalente',
    envCarMiles: 'Kilómetros',
    envNotDriven: 'no recorridos',
    ...
    pdfBreakEvenPeriod: 'Punto de Equilibrio',
    ...
    captureSignature: 'Firma del Cliente',
    signatureCaptured: 'Cliente Firmado',
    clear: 'Limpiar',
  },
  it: {
    title: 'SolarClose',
    ...
    envCo2Offset: 'Compensazione di CO2',
    envTreesPlanted: 'Alberi Piantati',
    envEquivalent: 'equivalente',
    envCarMiles: 'Chilometri',
    envNotDriven: 'non percorsi',
    ...
    pdfBreakEvenPeriod: 'Punto di Pareggio',
    ...
    captureSignature: 'Firma del Cliente',
    signatureCaptured: 'Cliente Firmato',
    clear: 'Cancella',
  },
  fr: {
    title: 'SolarClose',
    ...
    envCo2Offset: 'Compensation de CO2',
    envTreesPlanted: 'Arbres Plantés',
    envEquivalent: 'équivalent',
    envCarMiles: 'Kilomètres',
    ...
    pdfBreakEvenPeriod: 'Point d\'\u00c9quilibre',
    ...
    captureSignature: 'Signature du Client',
    signatureCaptured: 'Client Signé',
    clear: 'Effacer',
  },
  de: {
    title: 'SolarClose',
    ...
    pdfBreakEvenPeriod: 'Break-Even-Punkt',
    ...
    captureSignature: 'Kundenunterschrift',
    signatureCaptured: 'Kunde Unterschrieben',
    clear: 'Löschen',
  },
};
